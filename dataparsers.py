...
class TxtParser(object):
    ...
    def get_hex_key(string: str, byteslength=None):
        try:
            ...
            raise ValueError('Value "{}" at key "{}" is not a proper hexadecimal'.format(TxtParser.get_all_key(string), TxtParser.get_parent(string)))
    ...
    def get_float_key(string: str):
        try:
            ...
            raise ValueError('Value "{}" at key "{}" is not a proper float'.format(TxtParser.get_all_key(string), TxtParser.get_parent(string)))
    ...
    def get_int_key(string: str):
        try:
            ...
            raise ValueError('Value "{}" at key "{}" is not a proper int'.format(TxtParser.get_all_key(string), TxtParser.get_parent(string)))
    ...
    def get_bool_key(string: str):
        try:
            ...
            raise ValueError('Value "{}" at key "{}" is not a proper boolean'.format(TxtParser.get_all_key(string), TxtParser.get_parent(string)))
    ...
    def get_tuple_key(string: str):
        try:
            ...
            raise ValueError('Value "{}" at key "{}" is not a proper tuple'.format(TxtParser.get_all_key(string), TxtParser.get_parent(string)))
    ...
    def get_list_key(string: str):
        try:
            ...
            raise ValueError('Value "{}" at key "{}" is not a proper list'.format(TxtParser.get_all_key(string), TxtParser.get_parent(string)))
    ...
    def get_string_key(string: str):
        try:
            ...
            raise ValueError('Value "{}" at key "{}" is not a proper string'.format(TxtParser.get_all_key(string), TxtParser.get_parent(string)))

    @staticmethod
    def safe_write_value(file, value, size=1, byteorder='big', signed=False, allowfloat=True):
        if allowfloat is True:
            if '(' in value or ')' in value or '[' in value or ']' in value:
                raise ValueError('Value "{}" at key "{}" is not int or hexadecimal or float'.format(TxtParser.get_all_key(value), TxtParser.get_parent(value)))
        else:
            if '.' in value or '(' in value or ')' in value or '[' in value or ']' in value:
                raise ValueError('Value "{}" at key "{}" is not int or hexadecimal'.format(TxtParser.get_all_key(value), TxtParser.get_parent(value)))
        if '0x' in value:
